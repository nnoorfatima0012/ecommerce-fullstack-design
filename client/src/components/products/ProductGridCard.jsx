...
//       <div className="h-[230px] flex items-center justify-center p-5">
//         <img
//           src={product.image}
//           alt={product.title}
...
//           <button className="w-[36px] h-[36px] border border-gray-200 rounded-md flex items-center justify-center text-blue-600">
//             <Heart size={20} />
//           </button>
//         </div>
