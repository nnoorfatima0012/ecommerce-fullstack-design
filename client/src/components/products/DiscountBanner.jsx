...
//       <div className="bg-gradient-to-r from-blue-600 to-blue-400 rounded-md px-6 py-6 flex items-center justify-between">
...
//           </h2>
//           <p className="text-[15px] text-white/90 mt-1">
//             Have you ever finally just write dummy info
//           </p>
//         </div>

//         {/* Button */}
//         <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-md text-[15px] font-medium">
//           Shop now
//         </button>
