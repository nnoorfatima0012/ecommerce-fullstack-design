      ...
      <div className="max-w-[1180px] mx-auto px-4 py-3">
        ...
        <div className="hidden md:flex items-center justify-between">
          ...
          >
            ...
            <select className="border-l px-2 py-2 text-sm text-gray-600 outline-none">
              <option>All category</option>
            </select>

            <button
              type="submit"
              className="bg-blue-600 text-white px-5 py-2 transition hover:bg-blue-700"
            >
              Search
            </button>
          </form>
          ...
          <div className="flex items-center gap-6 text-gray-600 text-sm">
            {!isAuthenticated ? (
              <>
                <button
                  type="button"
                  onClick={() => navigate("/login")}
                  className="flex flex-col items-center gap-1 transition hover:text-blue-600"
                >
                  <LogIn size={20} />
                  <span>Login</span>
                </button>
              ...
              <>
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1 text-red-500 transition hover:text-red-600"
                >
                  <LogOut size={20} />
                  <span>Logout</span>
                </button>
            ...
            <button
              type="button"
              onClick={() => navigate("/cart")}
              className="relative flex flex-col items-center gap-1 transition hover:text-blue-600"
            >
