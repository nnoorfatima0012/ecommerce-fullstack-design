...
//               <div
//                 key={item.label}
//                 className="w-[48px] h-[55px] bg-gray-600 text-white rounded-md flex flex-col items-center justify-center"
//               >
...
//             <div
//               key={product.name}
//               className="border-r last:border-r-0 border-gray-200 p-4 flex flex-col items-center text-center min-h-[190px]"
//             >
//               <img
//                 src={product.image}
//                 alt={product.name}
...
//               <h3 className="mt-3 text-[15px] text-gray-800">
//                 {product.name}
//               </h3>
