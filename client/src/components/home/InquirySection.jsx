// //src/components/home/InquirySection.jsx
// function InquirySection() {
//   return (
//     <section className="max-w-[1180px] mx-auto px-4 pb-5">
//       <div
//         className="rounded-md overflow-hidden h-[300px] grid grid-cols-1 lg:grid-cols-[1fr_440px] px-8 py-6 gap-8 items-center"
//         style={{
//           backgroundImage:
...
//           <h2 className="text-[30px] font-semibold leading-tight max-w-[460px]">
//             An easy way to send <br />
//             requests to all suppliers
//           </h2>

//           <p className="mt-3 text-[15px] max-w-[430px] text-white/90">
...
//             className="w-full h-[36px] border border-gray-200 rounded-md px-3 outline-none text-sm mb-2"
//           />

//           <textarea
//             placeholder="Type more details"
//             className="w-full h-[55px] border border-gray-200 rounded-md px-3 py-2 outline-none text-sm mb-2 resize-none"
//           />
...
//               className="w-[150px] h-[34px] border border-gray-200 rounded-md px-3 outline-none text-sm"
//             />

//             <select className="w-[90px] h-[34px] border border-gray-200 rounded-md px-2 outline-none text-sm bg-white">
//               <option>Pcs</option>
//               <option>Kg</option>
//               <option>Box</option>
//             </select>

//             <button className="bg-blue-600 text-white px-4 h-[34px] rounded-md text-sm">
//               Send inquiry
//             </button>
//           </div>
//         </div>
