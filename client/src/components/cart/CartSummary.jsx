    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-xl sm:rounded-md p-4">
        ...
        <button
          ...
          className="hidden lg:block w-full bg-green-600 text-white rounded-md py-3 mt-4 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed"
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-3 z-50">
        <div className="flex items-center justify-between gap-3 max-w-[1180px] mx-auto">
          ...
          <button
            disabled={isCartEmpty}
            className="flex-1 max-w-[220px] bg-green-600 text-white rounded-md py-3 font-medium disabled:bg-gray-300 disabled:cursor-not-allowed"
            onClick={() => navigate("/checkout")}
          >
            Checkout
          </button>
